...
WebUI.navigateToUrl('http://kandinsky-wordpress-20.tw1.ru/campaign/nuzhna-pomoshh-proizvolnye-polya/')
...
WebUI.click(findTestObject('fortext/Page_( ) -/div__leyka-star-field-frame'))

WebUI.setText(findTestObject('Object Repository/custfi/Page_( ) -/input__leyka_eto-tekst'), 'text')

WebUI.click(findTestObject('forphone/Page_( ) -/div_,_leyka-star-field-frame'))

WebUI.setText(findTestObject('forphone/Page_( ) -/input_,_leyka_telefon'), '75554443322')

WebUI.click(findTestObject('fordate/Page_( ) -/div_,_leyka-star-field-frame'))

WebUI.setText(findTestObject('fordate/Page_( ) -/input_,_leyka_data'), '10112000')
